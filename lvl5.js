...
Q.scene("level5",function(stage) {		
    ...
    var levelAssets = [
		...
		// Quatrieme niveau
			["DrawEnnemy", {x: 1575 , y : 1125, coox : 1545, cooy : 1085, tps :10,  asset : "boite.png"}],
			["Sol_pierre2_D", {x: 385 , y : 1295, asset : "fond_pierre.png"}],
			["Sol_pierre2_D", {x: 455 , y : 1295, asset : "fond_pierre.png"}],
			["Sol_pierre2_D", {x: 525 , y : 1295, asset : "fond_pierre.png"}],
			["Sol_pierre2_D", {x: 595 , y : 1295, asset : "fond_pierre.png"}],
			["Sol_pierre2_D", {x: 665 , y : 1295, asset : "fond_pierre.png"}],
			["Sol_pierre2_D", {x: 735 , y : 1295, asset : "fond_pierre.png"}],
			["Sol_pierre2_D", {x: 805 , y : 1295, asset : "fond_pierre.png"}],
			["Sol_pierre2_D", {x: 875 , y : 1295, asset : "fond_pierre.png"}],
			["Sol_pierre2_D", {x: 945 , y : 1295, asset : "fond_pierre.png"}],
			["Sol_pierre2_D", {x: 1015 , y : 1295, asset : "fond_pierre.png"}],
			["Sol_pierre2_D", {x: 1085 , y : 1295, asset : "fond_pierre.png"}],
			["Sol_pierre2_D", {x: 1155 , y : 1295, asset : "fond_pierre.png"}],
			["Sol_pierre2_D", {x: 1225 , y : 1295, asset : "fond_pierre.png"}],
			["Sol_pierre2_D", {x: 1295 , y : 1295, asset : "fond_pierre.png"}],
			["Sol_pierre2_D", {x: 1365 , y : 1295, asset : "fond_pierre.png"}],
