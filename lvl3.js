        ...
        Q.scene("level3",function(stage) {
            ...
            var levelAssets = [
				...
				["Sol_pierre1_D", {x: 55*70+35 , y : 21*70+35}],
				["Sol_pierre1_D", {x: 57*70+35 , y : 21*70+35}],
				["Sol_pierre1_D", {x: 52*70+35 , y : 21*70+35}],
				["Sol_pierre1_D", {x: 51*70+35 , y : 21*70+35}],
				["Sol_pierre1_D", {x: 50*70+35 , y : 21*70+35}],
				["Sol_pierre1_D", {x: 49*70+35 , y : 21*70+35}],
				["Sol_pierre1_D", {x: 48*70+35 , y : 21*70+35}],
				["Sol_pierre1_D", {x: 47*70+35 , y : 21*70+35}],
