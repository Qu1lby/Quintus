	   ...
	   Q.scene("level3",function(stage) {
            ...
            var levelAssets = [
				...
				//pic 
				["Mal", {x: 24*70+35 , y : 20*70+35}],
				["Mal", {x: 25*70+35 , y : 20*70+35}],
				["Mal", {x: 26*70+35 , y : 20*70+35}],
				["Mal", {x: 27*70+35 , y : 20*70+35}],
				["Mal", {x: 28*70+35 , y : 20*70+35}],
				["Mal", {x: 29*70+35 , y : 20*70+35}],
